...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/r-minicran-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/r-minicran-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/r-minicran-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/r-minicran-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/r-minicran-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/r-minicran-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-minicran/badges/version.svg)](https://anaconda.org/conda-forge/r-minicran)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-minicran/badges/downloads.svg)](https://anaconda.org/conda-forge/r-minicran)
